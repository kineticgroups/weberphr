...
if(isset($_POST['PayrollDeductables']) AND
  ...
  else if(isset($_POST['ShowHtml']))
  {
    ...
    echo '<p class="page_title_text"><img alt="" src="' . $RootPath . '/css/' . $Theme . '/images/money_delete.png" title="' .
      _('Tax Report') . '" />' . ' ' . _('Payroll Reporting') . '</p>';
    echo '<div class="centre"><br /><a href="'. $RootPath . '/HrDeductablesReports.php">' . _('Back to Selection') . '</a></div>';
    ...
    /*The option to print PDF or ShowHtml was not hit */
    	...
    	echo '<tr><td>' . _('Payroll Deductables to Report On') . ':</td>
    			<td><select name="PayrollDeductables[]" multiple >';
    	...
    	echo '</select></td>
    		...
    		<br />
    		<div class="centre">
          <input type="submit" name="ShowHtml" value="' . _('Show Html') . '" />
