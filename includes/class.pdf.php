...
if (!class_exists('Cpdf', false)) {
	...
	*/
		...
		function RoundRectangleFill($x, $YPos, $width, $height, $rx, $ry,$round_corner='1111',$style='', $border_style=array(), $fill_color=array()) {
			...
			$this->RoundedRectXY($x, $this->h-$YPos, $width, $height, $rx, $ry,$round_corner, $style, $border_style, $fill_color);// Public function RoundedRectXY() in ~/includes/tcpdf/tcpdf.php.
		}
