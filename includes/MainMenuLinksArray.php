...
$ModuleLink = array('orders', 'AR', 'PO', 'AP', 'stock', 'manuf',  'GL', 'FA', 'HR','PA','PC', 'system', 'Utilities');
...
$MenuItems['FA']['Maintenance']['URL'] = array(	'/FixedAssetCategories.php',
												...
												$MenuItems['HR']['Transactions']['Caption'] = array(_('Search Employees'),
																									_('Add new Employee'),
																									_('Generate Payroll for Paygroup'),
																									_('Generate Pay for an Employee'),
																									_('Attendance Register'),
																									_('Apply for leave'),
																									//_('Approve Advance/Loan'),
																									_('Employee Loan/Advance Entry'),
																									_('See My Payslips'),
																									_('See My Leaves'));
												...
												$MenuItems['HR']['Maintenance']['Caption'] = array(	//_('GL Posting Settings'),
																									_('Manage Employee Departments'),
																									_('Manage Employee Categories'),
																									_('Manage Employment Grades'),
																									_('Manage Employee Positions'),
																									//_('Manage Working Days'),
																									//_('Manage Leave Groups'),
																									_('Manage Leave Types'),
												...
												$MenuItems['HR']['Maintenance']['URL'] = array(	//'/HrGlSettings.php',
																								'/Departments.php',
																							...
																							/*'/HrNotificationSettings.php'*/);
																								...
																								$MenuItems['PA']['Transactions']['Caption'] = array(_('Search Projects'),
																																					_('Add Project'),
																								...
																								$MenuItems['PA']['Reports']['Caption'] = array(	_('Employee Time Report'),
																																				_('Project Summary Reports/Resources'),
																																						_('Project Status Report'),
																																				_('Project Invoices'),
																																				_('Project Purchase Orders')
																																			   );
																								...
																								$MenuItems['PA']['Maintenance']['Caption'] = array(
																																					_('Project Types'),
																																					_('Project Statuses'),
																																					_('Customers'),
																																					_('Employees'),
																																					_('Timesheet Settings'),
																																					_('Billing Terms'));

																								$MenuItems['PA']['Maintenance']['URL'] = array(
																																				'/PaProjectTypes.php',
																																				'/PaProjectStatus.php',
																																				'/SelectCustomer.php',
																																				'/HrSelectEmployee.php',
																																				'/PaTimesheetsSettings.php',
																																				'/PaProjectBillingTerm.php');
...
$MenuItems['system']['Reports']['Caption'] = array(	_('Sales Types'),
													...
													_('Set Payment Voucher Authorisation levels'),
													_('Payment Methods'),
													_('Sales People'),
													_('Sales Areas'),
													_('Shippers'),
