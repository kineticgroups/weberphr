<?php
/*	$Id: PDFQuotation.php 7751 2017-04-13 16:34:26Z rchacon $*/
...
if (DB_num_rows($result)>0){
	...
	while ($myrow2=DB_fetch_array($result)){
		...
		$LeftOvers = $pdf->addTextWrap(420, $YPos+35,85,$FontSize,$DisplayQty,'right');
		$LeftOvers = $pdf->addTextWrap(485, $YPos+35,85,$FontSize,$DisplayPrice,'right');
		if ($DisplayDiscount > 0) {
			$LeftOvers = $pdf->addTextWrap(535, $YPos+35,85,$FontSize,$DisplayDiscount,'right');
		}
		$LeftOvers = $pdf->addTextWrap(585, $YPos+35,85,$FontSize,$DisplayTaxClass,'right');
		$LeftOvers = $pdf->addTextWrap(650, $YPos+35,85,$FontSize,$DisplayTaxAmount,'right');
