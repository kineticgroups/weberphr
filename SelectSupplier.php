<?php
/* $Id: SelectSupplier.php 7751 2017-04-13 16:34:26Z rchacon $*/
...
if (isset($_SESSION['SupplierID'])) {
	...
	$sql3="SELECT remittance
	FROM suppliers WHERE supplierid='".$_SESSION['SupplierID']."'";
	$result3 = DB_query($sql3);
	$myrow3 = DB_fetch_array($result3);
	if($myrow3['remittance']==1){
		echo '<a href="' . $RootPath . '/SupplierPaymentVouchers.php?New=true&amp;SupplierID=' . $_SESSION['SupplierID'] . '">' . _('Enter a Suppliers Payment Voucher') . '</a><br />';
		echo '<a href="' . $RootPath . '/SupplierPayVoucher.php?SupplierID=' . $_SESSION['SupplierID'] . '">' . _('Enter a Payment for Voucher') . '</a><br />';
	}
